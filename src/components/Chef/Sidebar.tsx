...
import { UtensilsCrossed, History, ChefHat, Settings, LogOut } from 'lucide-react';
    ...
    <aside className="fixed left-0 top-0 w-64 h-screen bg-[#F8F9FA] border-r border-[#EAEAEA] flex flex-col pt-8 pb-6 px-4 z-40">
      ...
      <div className="mt-auto space-y-4">
        <button
          ...
          className="w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all font-medium text-gray-600 hover:bg-gray-100 hover:text-red-600"
        >
          <LogOut size={20} />
          <span>Đăng xuất</span>
        </button>
