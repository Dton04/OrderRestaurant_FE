            ...
            {tables.map((table) => {
              ...
              return (
                <button
                  ...
                  className={`relative flex flex-col items-center justify-center py-5 rounded-2xl transition-all active:scale-95 ${isSelected
                ...
                >
                  <span
                    className={`text-xl font-extrabold ${isSelected ? 'text-white' : 'text-gray-900'
                      }`}
                  >
                    {table.label}
                  </span>
                  <span
                    className={`text-[10px] font-extrabold mt-1.5 tracking-widest ${isSelected ? 'text-orange-100' : 'text-gray-400'
                      }`}
                  >
                    {table.status}
                  </span>
          ...
          <div className="space-y-6">
            ...
            <div className="pt-2 text-center pb-2">
              <button
                ...
                className="w-full bg-[#ef5b1b] hover:bg-[#e04a09] active:scale-[0.98] text-white font-extrabold py-4 rounded-2xl shadow-[0_8px_25px_-8px_rgba(239,91,27,0.6)] hover:shadow-[0_12px_25px_-8px_rgba(239,91,27,0.7)] transition-all flex items-center justify-center gap-3 text-lg group"
              >
